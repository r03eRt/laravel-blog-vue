...
{{--                    </li>--}}
                    ...
                    <li class="user-footer">
                        <div class="pull-right">
                            <form method="POST" action="{{ route('logout') }}">
                                {{ csrf_field() }}
                                <button class="btn btn-default btn-block">Cerarr sesión</button>
                            </form>
                        </div>
                    </li>
                </ul>
    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            ...
            {{-- para capturar si viene un mensaje con un flag --}}
...
<script>
    var $modal = document.querySelector('#exampleModal .form-group');
    if($modal && $modal.classList.contains('has-error')) {
